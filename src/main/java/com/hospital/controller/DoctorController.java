...
public class DoctorController {
	...
	public ResponseEntity<DoctorDto> createDoctor(@PathVariable int hospitalId, @RequestBody DoctorDto doctorDto) {
	...
	public ResponseEntity<ApiResponse> deleteDoctorById(@PathVariable int doctorId) {
		...
		ApiResponse response = new ApiResponse("Doctor record is deleted successfully", true);
